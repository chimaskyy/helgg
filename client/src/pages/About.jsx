    ...
    <>
      ...
      <section className={`${sects}`} id="our-story">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start lg:gap-2">
          ...
          <div className="flex flex-col lg:flex-row lg:w-90% justify-between items-center lg:items-start lg:gap-12 bg-gray-200 rounded-3xl w-full">
            <div className="w-full lg:w-2/5 p-6">
              ...
              <p className="pb-4">
                ...
                2019 when three spirited undergraduates from Covenant University
                set foot in the electrifying realm of Silicon Valley, California
                for the Enactus World Cup. Little did they know that their
                encounter with Bird&apos;s electric scooters would ignite an
                unstoppable wave of inspiration and passion within them. And
                just like that, Helgg Inc was born—a visionary company with a
                mission to disrupt and digitize the African transportation
                sector by introducing eco-friendly, low-carbon waste electric
                vehicles that cater to the needs of Africa&apos;s ever-growing
                population. Imagine this: a dynamic network of electric vehicles
                crisscrossing the continent, turning heads and leaving a greener
                footprint in their wake. So, buckle up and join us on this
                incredible journey. Together, we can create a future where
                getting from point A to point B is a safe and liberating
                experience.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-24">
            <div className="rounded-3xl">
              ...
              <div className="lg:hidden bg-white rounded-b-3xl">
                <h1 className="p-8 text-customBlue text-2xl">Sustainability</h1>
            ...
            <div className="rounded-3xl">
              ...
              <div className="lg:hidden bg-white rounded-b-3xl">
                ...
                <p className="p-8 text-black">
                  Our commitment to innovation drives us to redefine the travel
                  experience. We constantly seek out new technologies and
                  creative solutions to enhance your journey, making it more
                  thrilling, convenient, and extraordinary.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl pb-8">
              ...
              <div className="lg:hidden bg-white rounded-b-3xl">
                ...
                <p className="p-8  text-black">
                  ...
                  mile to ensure secure and reliable transportation, giving you
                  peace of mind with every ride.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="m-6 pt-12" id="leadership">
        <div>
          <img
            src={helgg1}
            alt=""
            className="hidden lg:block w-[1721px] h-[463px] object-cover"
          />
        </div>
        ...
        <div>
          <p className="text-center text-4xl p-12 font-bold">
            Our Amazing Team
          </p>
          ...
          <div className="flex flex-col lg:flex-row lg:w-90% justify-between items-center lg:items-start lg:gap-12 bg-gray-200 rounded-3xl w-full">
            <div className="w-full lg:w-2/5 p-6">
              ...
              <p className="mt-6 mb-8 text-lg text-gray-700">
                Ready to make a difference in African transportation? We&apos;re
                searching for like-minded individuals who share our passion for
                shaking things up. Join our team of experts and let&apos;s
