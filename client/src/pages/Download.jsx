        ...
        <section className="bg-gray-900 lg:p-12 mb-12 t0p-0 lg:rounded-b-[10%]">
          <div className="flex flex-col gap-8 lg:flex-row-reverse lg:justify-center lg:items-center">
            <div className="p-8 top-0 lg:m-8 text-white mb-6 font-roboto lg:w-2/3">
              ...
              <div className="pt-12 flex gap-16  lg:flex-row">
                <a
                ...
                >
                  <button
                    aria-label="Download from Google Play Store"
                    className="text-black group relative font-roboto  sm:px-6  sm:py-4 text-lg sm:text-sm rounded-full shadow-xl transition-transform transform bg-customGreen border-2 border-white hover:scale-105 hover:border-green-600 hover:shadow-green-500/50 hover:shadow-3xl focus:outline-none lg:text-lg lg:p-6"
                    id="downloadButton"
                  >
                    <FontAwesomeIcon
                      icon={faGooglePlay}
                ...
                >
                  <button
                    aria-label="Download from Apple App Store"
                    className="text-white group relative font-roboto  sm:px-6  sm:py-4 text-lg sm:text-sm rounded-full shadow-xl transition-transform transform  border-2 border-white hover:scale-105 hover:border-green-600 hover:shadow-green-500/50 hover:shadow-3xl focus:outline-none lg:text-lg lg:p-6"
                    id="downloadButton"
                  >
                    <FontAwesomeIcon
                      icon={faApple}
